...
There are three challenges. All code should be written in Swift and the solution should compile in Playgrounds without any warnings or errors. We are not strictly concerned with seeing a specific 'correct' answer. There are many ways to do all three challenges. Find one that works for you.  If you have any questions, e-mail interviews@devmounta.in.

* [Part 1: About Me](About%20Me)
* [Part 2: Basic Math](Basic%20Math)
* [Part 3: Control Flow](Control%20Flow)
