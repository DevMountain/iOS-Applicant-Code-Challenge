...
let age = 31
let address = "Waltham, MA"
var myWhy = "I always was fascinated with people who could design their own apps and always day dreamed about doing it myself. Recently since my career was not going anywhere I decided to take the plunge and go for a career change into programming"
...
*/
var hobbies = ["Crossfit", "videogames", "reading", "photoshop"]
...
print("Hi my name is \(firstName) \(lastName) and I'm a \(age) year old male from \(address). \(myWhy)")
//: [Previous](@previous)
//: [Next](@next)
